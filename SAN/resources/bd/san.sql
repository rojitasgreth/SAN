...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-03-2023 a las 04:07:11
...
(0, 'Grethmar', 'Rojas', 'F', 4, 'A', '', 'Luzmary', 'R'),
(10156222, 'Alberth', 'Editadoo', 'M', 4, 'A', 'A', 'Luzmary', 'O'),
(62585, 'Ana', 'Farias', 'F', 4, 'A', NULL, 'Jhonny', 'R'),
(29921795, 'Grethmar', 'Rojas', 'F', 1, 'A', NULL, 'Luzmary', 'R'),
(1236785, 'andres', 'valderrama', 'M', 2, 'C', '', 'miguel perez', 'R'),
(1025635, 'Leona', 'Rojas', 'F', 2, 'C', '', 'Martin Torres', 'R'),
(54162357, 'Ana', 'Farias', 'F', 1, 'A', NULL, 'Pedro Farias', 'O'),
(5641984, 'Luisa ', 'Juarez', 'F', 1, 'A', NULL, 'Angel Juarez', 'R'),
(30148541, 'Pedro', 'Perez', 'M', 1, 'A', NULL, 'Petra Rojas', 'R'),
(15, 'Miguel', 'Editado', 'M', 1, 'A', NULL, 'Patricia Lopez', 'O'),
(29921795, 'Grethmar', 'Editado', 'F', 5, 'C', NULL, 'Luzmary Bastidas', 'R'),
(1455628, 'diego', 'blanco', 'M', 3, 'A', 'B', 'Jose miguel', 'O');
...
CREATE TABLE `perso` (
  ...
  `cargo` enum('Director','Coordinacion','Docente','Otro') DEFAULT 'Otro',
...
(1, 'Grethmar', '123', 'rojas@gmail.com', 1, 'activo', 'Otro', '2023-03-23 00:06:53'),
